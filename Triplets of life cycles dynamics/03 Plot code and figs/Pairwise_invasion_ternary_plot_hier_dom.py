...
# FolderMask = '../../OriginalData/Triplet invasions/Bistability_to_plot/'
# OutputName = 'Bistabilty_v2.jpg'

# FolderMask = '../../OriginalData/Triplet invasions/Coexistence_to_plot/'
# OutputName = 'Coexistence_v2.jpg'

FolderMask = '../02 Data/HierDom_to_plot/'
OutputName = 'HierDom_v2.jpg'

# FolderMask = '../../OriginalData/Triplet invasions/NonhierDom_to_plot/'
