...
v2.1.1 changed the method of solve_ivp in LifeCyclesCompetition() to 'DOP853' and increased rtol to 1e-5
"""
...
#    Derivative = PopDynamics([], X_init, Combined_projection, Combined_interaction)
    DynSol = solve_ivp(PopDynamics, [0, np.max(RecordTimes)], X_init, t_eval = RecordTimes, args=(Combined_projection, Combined_interaction), rtol = 1e-5, method='DOP853').y
